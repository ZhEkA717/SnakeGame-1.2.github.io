document.addEventListener("DOMContentLoaded", function (event) {
    ...
    function orientFun(EO) {
        ...
        gameOver.style.width=canvas.offsetWidth*0.9+'px';
    }
    ...
    buttonRestart.addEventListener('touchstart', funClickRestart);
...
fieldNik.addEventListener('touchstart',funFocusInput);
...
buttonExit.addEventListener('touchstart', funClose);
...
buttonSave.addEventListener('touchstart', funClickSave, false);
